      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-20">
        <div className="text-center">
          ...
          <p className="text-gray-600 dark:text-gray-400 mb-12 max-w-4xl mx-auto leading-relaxed">
            I'm a highly skilled backend developer proficient in C#, Java, .NET, and Spring. I focus on high-quality code, API design, DevOps, and scalable backend systems, with a passion for team leadership and innovation.
          </p>
